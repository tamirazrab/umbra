import type { MemoryCacheSetType } from "./memory/types";
import type {
...
export abstract class ICacheAdapter<T = unknown> {
	client!: T;
	...
	abstract del<TKey extends RedisCacheKeyArgument = RedisCacheKeyArgument>(
		key: TKey,
	): Promise<void> | boolean;

	abstract get<TKey extends RedisCacheKeyArgument = RedisCacheKeyArgument>(
		key: TKey,
	...
	abstract pExpire<
		PCache extends RedisCacheKeyArgument = RedisCacheKeyArgument,
	>(key: PCache, milliseconds: number): Promise<void> | boolean;

	abstract hGet<
		TKey extends RedisCacheKeyArgument = RedisCacheKeyArgument,
		TArs extends RedisCacheKeyArgument = RedisCacheKeyArgument,
	>(key?: TKey, field?: TArs): Promise<unknown | unknown[]> | undefined;

	abstract hSet<
		TKey extends RedisCacheKeyArgument = RedisCacheKeyArgument,
		TArgs extends RedisCacheKeyArgument = RedisCacheKeyArgument,
		TValue extends RedisCacheValueArgument = RedisCacheValueArgument,
	>(key?: TKey, field?: TArgs, value?: TValue): Promise<number> | undefined;

	abstract hGetAll<TKey extends RedisCacheKeyArgument = RedisCacheKeyArgument>(
		key: TKey,
	): Promise<unknown | unknown[]> | undefined;

	abstract mSet<TSet extends MemoryCacheSetType = MemoryCacheSetType>(
		model?: TSet[],
	): boolean;
