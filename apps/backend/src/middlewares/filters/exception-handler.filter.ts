import {
	type ExceptionFilter as AppExceptionFilter,
	type ArgumentsHost,
	Catch,
	HttpException,
} from "@nestjs/common";
...
import type { ILoggerAdapter } from "@/infra/logger/adapter";
...
export class ExceptionHandlerFilter implements AppExceptionFilter {
	...
	private logError(exception: BaseException): void {
		...
		this.loggerService.error(
			new ApiInternalServerException(exception.message, logContext),
		);
	}
